...
return new class extends Migration
{
    ...
    {
        Schema::create('dealer_transaction_parties', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('represents_group_id')->nullable();
    ...
    {
        Schema::dropIfExists('dealer_transaction_parties');
    }
};
